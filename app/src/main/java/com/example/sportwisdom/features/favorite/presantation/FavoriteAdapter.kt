...
import com.example.sportwisdom.features.favorite.presantation.FavoriteAdapter.FavoriteViewHolder
import com.example.sportwisdom.features.search.domain.model.TeamDto
import kotlinx.android.synthetic.main.item_team.view.*

class FavoriteAdapter(private val onclick: (TeamDto) -> Unit, private val onDelete: (TeamDto) -> Unit) : ListAdapter<TeamDto, FavoriteViewHolder>(FavoriteAdapter) {
